...
import CarouselCSA from "@/components/Carousel";
  ...
  return (
    <div className="relative mb-[5%] mt-[2%] flex flex-row">
      <Image
        src={rabbit}
        alt="rabbit"
        className="absolute bottom-[-13%] left-[2%] z-40 h-1/2 w-1/3 md:left-[12%]"
      />
      <Image
        src={bamboo}
        alt="bamboo"
        className="absolute bottom-[13%] z-40 h-[87%] w-[40%] md:left-[46.5%]"
      />
