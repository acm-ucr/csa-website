  ...
  return (
    <div>
      <div className="mt-10 flex flex-col">
        <p className="mr-6 text-right text-5xl font-semibold text-csa-red-100">
          Four Pillars
        </p>
      ...
      <div className="mt-12 grid grid-cols-2 justify-items-start gap-7 overflow-x-clip pb-10 sm:gap-6 md:gap-20 lg:overflow-visible">
        <div className="relative col-span-2 ml-5 flex h-[8vh] w-[64vw] items-center rounded-3xl border-8 border-csa-green-100 bg-white sm:w-1/2 md:ml-20 md:h-[12vh] md:w-2/5">
        ...
        <div className="relative row-start-2 ml-40 flex h-[8vh] w-full items-center rounded-3xl border-8 border-csa-gray-100 bg-white sm:ml-80 sm:w-[42vw] md:col-start-2 md:ml-2 md:h-[12vh]">
          ...
          <Image
            src={Pendant}
            alt="Pendant"
            className="absolute right-0 w-5/12 md:w-[15vw] lg:w-[9vw]"
          />
        </div>

        <div className="relative col-span-2 ml-5 flex h-[8vh] w-[64vw] items-center rounded-3xl border-8 border-csa-red-100 bg-white sm:w-1/2 md:ml-20 md:h-[12vh] md:w-2/5">
        ...
        <div className="relative col-start-1 ml-40 flex h-[8vh] w-full items-center rounded-3xl border-8 border-csa-yellow-200 bg-white sm:ml-80 sm:w-[42vw] md:col-start-2 md:ml-2 md:h-[12vh]">
