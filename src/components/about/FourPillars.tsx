    ...
    <div className="grid grid-cols-2 justify-items-start gap-7 sm:gap-6 md:gap-20">
      <div className="relative col-span-2 ml-5 flex h-[8vh] w-[64vw] items-center rounded-3xl border-8 border-csa-green-100 bg-white sm:w-[48vw] md:ml-20 md:h-[12vh] md:w-[42vw]">
        ...
        <Image
          src={HeartImage}
          alt="heartImage"
          className="absolute right-[-20%] top-[-100%] w-[24vw] sm:right-[-20%] sm:top-[-130%] sm:w-[18vw] md:right-[-20%] md:top-[-60%] md:w-[18vw] lg:top-[-120%] lg:w-[14vw]"
        />
      </div>
      <div className="sm:[60vw] relative row-start-2 ml-44 flex h-[8vh] w-[50vw] items-center rounded-3xl border-8 border-csa-gray-100 bg-white sm:ml-96 sm:w-[42vw] md:col-start-2 md:ml-2 md:h-[12vh] md:w-[42vw]">
        <p className="ml-6 text-3xl font-bold text-csa-gray-100 md:ml-8 lg:text-4xl">
          Social
        </p>
        <Image
          src={Pendant}
      ...
      <div className="relative col-start-1 ml-24 flex h-[8vh] w-[72vw] items-center rounded-3xl border-8 border-csa-yellow-100 bg-white sm:ml-80 sm:w-[48vw] md:col-start-2 md:ml-3 md:h-[12vh] md:w-[40vw]">
        <p className="ml-6 text-3xl font-bold text-csa-gray-100 sm:ml-8 lg:text-4xl">
          Academic
        </p>
        <Image
          src={gradCap}
          alt="gradCap"
          className="absolute w-[42vw] translate-x-[80%] translate-y-[-12%] sm:translate-x-[40%] sm:translate-y-[-9%] md:w-[28vw] md:translate-x-[60%] md:translate-y-[-9%] lg:w-[18vw] lg:translate-x-[120%]"
        />
      </div>
    </div>
  );
