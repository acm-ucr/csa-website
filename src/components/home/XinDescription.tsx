...
const XinDescription = () => {
  return (
    <div className="grid grid-cols-1 items-center border-y-8 border-csa-tan-300 bg-csa-green-100 md:grid-cols-3">
      <p className="md:py-[6vh] pt-[4vh] px-[4vh] md:pl-[4vw] text-left text-2xl text-white md:col-span-2 md:text-2xl">
      ...
      <div className="relative flex items-center justify-center md:py-[6vh] my-[6vh]">
