  ...
  return (
    <div>
      ...
      <div className="relative ml-[15vw] border-l-8 border-csa-tan-300 px-10 pl-5 sm:my-12 sm:ml-[30vw]">
        ...
        />
        <p className="text-left text-3xl font-bold text-csa-red-100 sm:text-4xl">
          Mission statement
        </p>
        <p className="font-lora mt-4 pr-[17vw] text-left text-xl font-semibold leading-relaxed text-csa-gray-100 sm:text-2xl">
